...
class Chocolate {
	...
	protected $iidchocolate; // ID del chocolate, es de tipo integer.
	protected $cnombre;// nombre del chocolate, es de tipo cadena.
	protected $cdescripcion;//descripción del chocolate, es de tipo cadena.
	protected $imagen; //imagen del chcolate, es de tipo blop.
